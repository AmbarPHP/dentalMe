            ...
            <Row className='desktop w-100 ' >
                ...
                <Col lg={{ span: 2, offset: 1 }} className="pb-3 pt-3" >
                    <div className='columna-doble d-flex justify-content-center align-items-center'>
                        <a href="http://locahost:3000/" style={{ fontSize: 18 + "px" }} className="me-4 text-primary ">
                            <FaWhatsapp />
                        </a>
                ...
                <Col lg={{ span: 3, offset: 0 }} className="pb-3 pt-3" >
                    <div className='columna-doble d-flex justify-content-center align-items-center'>
                        <a href="http://localhost/" style={{ fontSize: 18 + "px" }} className="me-4 text-primary bold">
                            <FaMapMarkerAlt />
                        </a>
                        <span className='text-primary pe-2'> Av. de la Cultura #94 Int.2 en Plaza Manglar </span>
                    </div>
                </Col>
