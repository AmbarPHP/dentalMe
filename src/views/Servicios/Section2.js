    ...
    <Container name="section2-servicios" className=" bg-light">
      ...
      <Row>
        <Col className="d-flex justify-content-center flex-column">
          ...
          <p className="font-3rem text-secondary ms-5">1</p>
          <h1 className="text-primary bold">Gratis</h1>
          <p className="lead">
          ...
          <p className="text-secondary">
            *Pregunta por nuestros terminos y condiciones
          </p>
        </Col>
        <Col>
          <p className="font-2rem text-gray">
          ...
          <p className="font-3rem text-secondary ms-5">2</p>
          <h1 className="text-primary bold">Gratis</h1>
          <p className="lead text-primary bold">Diagnóstico y Radiografía</p>
